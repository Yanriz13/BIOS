...
<div class="container mx-auto py-10">
    ...
    <div class="bg-white rounded-2xl shadow-lg p-8 max-w-xl mx-auto">
        ...
        <h1 class="text-3xl font-bold mb-2">Edit Departemen</h1>
        <p class="text-gray-500 mb-8">Ubah informasi departemen</p>
        ...
        <form action="{{ route('superadmin.departemen.update', $departemen->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <select name="divisi_id" required
                        ...
                        @foreach($divisis as $divisi)
                            <option value="{{ $divisi->id }}" {{ old('divisi_id', $departemen->divisi_id) == $divisi->id ? 'selected' : '' }}>
                                {{ $divisi->nama }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="3"
                               class="w-full border rounded-xl px-4 py-3 mt-2 focus:outline-none focus:ring-2 focus:ring-blue-300">{{ old('deskripsi', $departemen->deskripsi) }}</textarea>
                </div>
